...
int main(void)
{
	...
	//ADC_RegularChannelConfig(ADC1, ADC_Channel_5, 3, ADC_SampleTime_239Cycles5); // opcjonalny kolejny kana³
	...
	while (1)
	{
		for (i = 0; i < ADC_CHANNELS;i++)
		{
			...
			send_int(i);
			send_string(" --> ");
			send_int(adc_value[i]);
			send_string("\r\n");
		}
		send_string("__________________________________________________\r\n\r\n");
