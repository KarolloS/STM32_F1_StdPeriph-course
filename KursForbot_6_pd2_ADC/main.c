...
void send_float(float f,int base);
...
int main(void)
{
	...
	while (1)
	{
		...
		adc = suma / 1000.;
		send_string("Sample time equal to 1.5 cycles  -->  ADC = ");
		send_int(adc);
		send_string(" (");
		adc = adc * 3.3 / 4096.0;
		send_float(adc, 2);
		...
		adc = suma / 1000.;
		send_string("Sample time equal to 7.5 cycles  -->  ADC = ");
		send_int(adc);
		send_string(" (");
		adc = adc * 3.3 / 4096.0;
		send_float(adc, 2);
		...
		adc = suma / 1000.;
		send_string("Sample time equal to 13.5 cycles  -->  ADC = ");
		send_int(adc);
		send_string(" (");
		adc = adc * 3.3 / 4096.0;
		send_float(adc, 2);
		...
		adc = suma / 1000.;
		send_string("Sample time equal to 28.5 cycles  -->  ADC = ");
		send_int(adc);
		send_string(" (");
		adc = adc * 3.3 / 4096.0;
		send_float(adc, 2);
		...
		adc = suma / 1000.;
		send_string("Sample time equal to 41.5 cycles  -->  ADC = ");
		send_int(adc);
		send_string(" (");
		adc = adc * 3.3 / 4096.0;
		send_float(adc, 2);
		...
		adc = suma / 1000.;
		send_string("Sample time equal to 55.5 cycles  -->  ADC = ");
		send_int(adc);
		send_string(" (");
		adc = adc * 3.3 / 4096.0;
		send_float(adc, 2);
		...
		adc = suma / 1000.;
		send_string("Sample time equal to 71.5 cycles  -->  ADC = ");
		send_int(adc);
		send_string(" (");
		adc = adc * 3.3 / 4096.0;
		send_float(adc, 2);
		...
		adc = suma / 1000.;
		send_string("Sample time equal to 239.5 cycles  -->  ADC = ");
		send_int(adc);
		send_string(" (");
		adc = adc * 3.3 / 4096.0;
		send_float(adc, 2);
