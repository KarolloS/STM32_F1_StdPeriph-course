...
//uint32_t SystemCoreClock = 64000000; //When the HSI is used as a PLL clock input, the maximum system clock
...
static void SetSysClock(void)
{
  ...
  { /* If HSE fails to start-up, the application will have wrong clock 
    configuration. HSI (~8 MHz) used to clock the PLL, and the PLL is used as system clock source */
